...
#define USER_KEYMAPS { \
 ...
 \
    ...
    KC_PLUS,  KC_1,  KC_2,   KC_3,    KC_MINS,     KC_F6,   KC_F7,    KC_F8,   KC_F9,   KC_F10, \
                     KC_DOT, KC_COMM, KC_TAB,      KC_NO,   KC_NO,    KC_NO \
    ), \
 \
    [_OS] = WOX_LAYOUT( \
    KC_NO,    KC_NO,    KC_NO,    KC_NO,   RESET,       HYPR(KC_P), HYPR(KC_1),    HYPR(KC_UP),   HYPR(KC_2),    HYPR(KC_M), \
    KC_CAPS,  KC_VOLD,  KC_MUTE, KC_VOLU, KC_NO,       LCA(KC_E),  HYPR(KC_LEFT), HYPR(KC_ENT),  HYPR(KC_RGHT), LCA(KC_T), \
